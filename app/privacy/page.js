    ...
    <>
      ...
      <div className="wrap">
        <div className="page-card">
          ...
          <p>All data in transit is encrypted using HTTPS/TLS. Profile settings are stored locally on your device or in your configured environment.</p>

          <h2>6. Your Rights</h2>
          <p>You can update, edit, or clear your contact profile at any time through your app settings.</p>

          <h2>7. Contact Us</h2>
          <p>For privacy questions or data requests, contact us at <a href="mailto:privacy@nexlink.co.za">privacy@nexlink.co.za</a>.</p>
        </div>
      </div>
    </>
  );
